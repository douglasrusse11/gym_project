...
instructional_event1 = InstructionalEvent("Yoga", datetime(2021, 11, 14, 18), 90)
instructional_event_repository.save(instructional_event1)
instructional_event2 = InstructionalEvent("Martial Arts", datetime(2021, 11, 13, 19), 60, [member1, member2], 1)
instructional_event_repository.save(instructional_event2)
instructional_event3 = InstructionalEvent("Martial Arts", datetime(2021, 11, 13, 10), 60, [member1, member2], 1)
