...
class TestMember(unittest.TestCase):
    def setUp(self):
        ...
        self.member4 = Member("Augusta", "Eldrick", date(1997, 11, 16), "crobles@yahoo.ca")
        self.member5 = Member("Augusta", "Eldrick", date(1997, 11, 17), "crobles@yahoo.ca")
        self.member6 = Member("Augusta", "Eldrick", date(1997, 11, 18), "crobles@yahoo.ca")
